...
export function NavPill({
  ...
  return (
    <NavLink
      ...
      className={({ isActive }) =>
        cn(
          "flex min-h-11 items-center rounded-full px-4 text-sm font-semibold transition focus-visible:outline-none focus-visible:ring-2 motion-reduce:transition-none",
          tone === "dark"
