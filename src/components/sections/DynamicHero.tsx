...
export function DynamicHero({ content }: { content: SiteContent["hero"] }) {
  ...
  return (
    <section
      ...
      className="relative flex min-h-[620px] items-center overflow-hidden bg-hero-main bg-cover bg-center pb-20 pt-28 text-white md:min-h-[680px] md:pb-24 md:pt-32"
    >
